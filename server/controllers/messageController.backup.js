    ...
    try {
        ...
        if (user && user.isTeamMember && propertyId && propertyId !== 'general') {
            ...
            if (assignedLead) {
                ...
                console.log('[GET_CHAT_HISTORY] Expanded query for team member');
            }
        }

        console.log('[GET_CHAT_HISTORY] Query:', JSON.stringify(query, null, 2));
        ...
        await Message.updateMany(
            { ...query, receiver: currentUserId, read: false },
            { read: true }
        );
