...
const Messages = () => {
    ...
    const handleSendMessage = async (e) => {
        ...
        console.log('[SEND] Selected conversation:', selectedConversation);
        ...
        if (!selectedConversation) {
            console.error('[SEND] No selected conversation!');
            alert('Please select a conversation first');
            return;
        }

        console.log('[OWNER_CHAT] Sending message to:', selectedConversation.user._id);
        console.log('[OWNER_CHAT] Property ID:', selectedConversation.property?._id);
        ...
        try {
            ...
            console.log('[OWNER_CHAT] Message sent successfully:', res.data);
            ...
            console.error('[OWNER_CHAT] Error response:', err.response?.data);
    ...
    return (
        <div style={{ background: 'radial-gradient(ellipse at 10% 20%, rgba(59,130,246,0.08) 0%, transparent 50%), radial-gradient(ellipse at 90% 80%, rgba(139,92,246,0.06) 0%, transparent 50%), #0a1628', minHeight: '100vh', color: 'white' }}>
            <Navbar user={user} />
